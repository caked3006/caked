...
define( 'FOODPRESS_VERSION', '1.4.4' );
...
function foodpress_css_script(){
	...
	if( $link_color ){
        ...
        $css .= '.tns-nav button.tns-nav-active{background:'.$link_color.';}';
...
function foodpress_head_js_main(){
    ...
    const main = {
        ...
        "font_uri" : <?php echo $font_uri ? '"'.$font_uri.'"' : 'false'; ?>,
        "store_id" : "<?php echo $store_id; ?>",
        "store_name" : "<?php echo $store_name; ?>",
        "store_link" : "<?php echo $store_link; ?>",
        "store_ongkir" : "<?php echo $store_ongkir; ?>",
        "store_ongkir_name" : "<?php echo $store_ongkir_name; ?>",
        "store_ongkir_enable" : <?php echo $store_ongkir_enable; ?>,
        "store_ongkir_provider" : "<?php echo $store_ongkir_provider; ?>",
        "store_admin_phone" : "<?php echo $store_admin_phone; ?>",
        "store_opened_message" : "<?php echo $store_opened_message; ?>",
    };
    /* ]]> */
    </script>
    <?php
...
function foodpress_js_script(){
    ...
    ?>
    <script type="text/javascript">
	<?php include(get_template_directory().'/js/inline.js'); ?>
	</script>
	<?php
}
...
require FOODPRESS_PATH . '/inc/ongkir.php';
require FOODPRESS_PATH . '/inc/ongkir-rajaongkir.php';
require FOODPRESS_PATH . '/inc/ongkir-flatongkir.php';
